                   ...
                   String ph_number=tmgr.getLine1Number();
                    ...
                    if(c.getCount()>0) {
						while (c.moveToNext()) {
							...
							String target_name = c.getString(0);
							...
							smsManager.sendTextMessage(target_ph_number, null, "Please help me " + target_name + " My Current Location is:" + str_address, sentPI, deliveredPI);
					...
					{
						Toast.makeText(getApplicationContext(),"SMS sent failed..Please register atleast one guardian",Toast.LENGTH_SHORT).show();
